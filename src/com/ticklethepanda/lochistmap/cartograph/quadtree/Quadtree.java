...
public class Quadtree {
   ...
   * array. The size of each location in the map is defined by the ratio between
   * the window width and the number of columns: (rectangle width) / nCols.
   * 
   * @param nCols
   ...
   *          the rectangle defining the size and location of the window in the
   *          map
   * @return an array that represents the density of the Quadtree from a
   *         particular view.
   */
  public Heatmap convertToHeatmap(double nCols, double nRows,
