...
public class Quadtree {
    ...
    public Heatmap convertToHeatmap(double nCols, double nRows) {
        return convertToHeatmap(nCols, rectangle);
    }
     ...
     * nCols.
     *
     * @param nCols           the number of columns in the density array
     * @param windowRectangle the rectangle defining the size and location of the window in
     *                        the map
    ...
    public Heatmap convertToHeatmap(double nCols,
        ...
        double nRows = windowRectangle.getHeight() / (windowRectangle.getWidth() / nCols);

        System.out.println("ncols: " + nCols);
        System.out.println("nrows: " + nRows);
        System.out.println("window: " + windowRectangle.toString());
